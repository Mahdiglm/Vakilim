...
export const themes = [
  { 
    ...
    textGradient: 'linear-gradient(to right, #D4AF37, #FFEB8A, #D4AF37)',
  ...
  { 
    ...
    textGradient: 'linear-gradient(to right, #E5E4E2, #FFFFFF, #E5E4E2)',
  ...
  { 
    ...
    secondary: '#0C3547',
    textPrimary: '#FFFFFF',
    textSecondary: '#B8D8E5',
    accent: '#FF6347',
    gradient: 'linear-gradient(135deg, #FF7F50 0%, #FF6347 100%)',
    textGradient: 'linear-gradient(to right, #FF7F50, #FFAA90, #FF7F50)',
  ...
  { 
    ...
    textGradient: 'linear-gradient(to right, #0096FF, #80CAFF, #0096FF)',
  ...
  { 
    ...
    secondary: '#004B23',
    textPrimary: '#FFFFFF',
    textSecondary: '#C5E8D5',
    accent: '#4ADE80',
    gradient: 'linear-gradient(135deg, #50C878 0%, #4ADE80 100%)',
    textGradient: 'linear-gradient(to right, #50C878, #A5E0B8, #50C878)',
  ...
  { 
    ...
    secondary: '#1A0110',
    textPrimary: '#FFFFFF',
    textSecondary: '#EECCD8',
    accent: '#FF0F60',
    gradient: 'linear-gradient(135deg, #E0115F 0%, #FF0F60 100%)',
    textGradient: 'linear-gradient(to right, #E0115F, #FF88B0, #E0115F)',
  ...
  { 
    ...
    secondary: '#180028',
    textPrimary: '#FFFFFF',
    textSecondary: '#DDBDDD',
    accent: '#9900CC',
    gradient: 'linear-gradient(135deg, #800080 0%, #9900CC 100%)',
    textGradient: 'linear-gradient(to right, #800080, #D580D5, #800080)',
  ...
  { 
    ...
    secondary: '#2C1503',
    textPrimary: '#FFFFFF',
    textSecondary: '#E8D0B8',
    accent: '#D2691E',
    gradient: 'linear-gradient(135deg, #CD7F32 0%, #D2691E 100%)',
    textGradient: 'linear-gradient(to right, #CD7F32, #E8BF99, #CD7F32)',
  ...
  { 
    ...
    secondary: '#111827',
    textPrimary: '#FFFFFF',
    textSecondary: '#C2CAE0',
    accent: '#00FFFF',
    gradient: 'linear-gradient(135deg, #7DF9FF 0%, #00FFFF 100%)',
    textGradient: 'linear-gradient(to right, #7DF9FF, #BEFCFF, #7DF9FF)',
  ...
  { 
    ...
    secondary: '#1C0C29',
    textPrimary: '#FFFFFF',
    textSecondary: '#DAC4E5',
    accent: '#8E44AD',
    gradient: 'linear-gradient(135deg, #9B59B6 0%, #8E44AD 100%)',
    textGradient: 'linear-gradient(to right, #9B59B6, #CDACDB, #9B59B6)',
  ...
  { 
    ...
    secondary: '#00332B',
    textPrimary: '#FFFFFF',
    textSecondary: '#B8E8E5',
    accent: '#40E0D0',
    gradient: 'linear-gradient(135deg, #30D5C8 0%, #40E0D0 100%)',
    textGradient: 'linear-gradient(to right, #30D5C8, #98EAE3, #30D5C8)',
  ...
  { 
    ...
    secondary: '#331C00',
    textPrimary: '#FFFFFF',
    textSecondary: '#FFE0B8',
    accent: '#FFA500',
    gradient: 'linear-gradient(135deg, #FF8C00 0%, #FFA500 100%)',
    textGradient: 'linear-gradient(to right, #FF8C00, #FFC580, #FF8C00)',
...
export const ThemeProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty('--gradient-text', currentTheme.textGradient);
